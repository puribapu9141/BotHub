...
BAALAJI_TG_USER_BOT = "My Master Pratik Goswami PM hasn't Approved You to PM/DM."
TG_COMPANION_USER_BOT = "Please Wait for Pratik Goswami PM's Response & Yes, Don't Spam Here Else Your Account Will Be Banned."
UNIBORG_USER_BOT_WARN_ZERO = "I Am Currently Offline. Please Don't SPAM Here 😡."
UNIBORG_USER_BOT_NO_WARN = "[──▄█▀█▄─────────██ \n▄████████▄───▄▀█▄▄▄▄ \n██▀▼▼▼▼▼─▄▀──█▄▄ \n█████▄▲▲▲─▄▄▄▀───▀▄ \n██████▀▀▀▀─▀────────▀▀](t.me/PM_The_Angry) \n\n Thank You for Contacting Me, But I Am Offline Now, I'll Message You Once I'll Come online....."
    ...
    if Config.PM_LOGGR_BOT_API_ID is not None:
        if event.is_private:
            if not pmpermit_sql.is_approved(chat.id):
                ...
                await event.edit("[──███▅▄▄▄▄▄▄▄▄▄\n─██▐████████████\n▐█▀████████████▌▌\n▐─▀▀▀▐█▌▀▀███▀█─▌\n▐▄───▄█───▄█▌▄█](t.me/PM_The_Angry) \n\n My Master has Approved You to PM/DM Him...")
    ...
    if Config.PM_LOGGR_BOT_API_ID is not None:
        if event.is_private:
            if pmpermit_sql.is_approved(chat.id):
                ...
                await event.edit("[──███▅▄▄▄▄▄▄▄▄▄\n─██▐████████████\n▐█▀████████████▌▌\n▐─▀▀▀▐█▌▀▀███▀█─▌\n▐▄───▄█───▄█▌▄█](t.me/PM_The_Angry) \n\n My Master has Disapproved You to PM/DM Him...")
                await asyncio.sleep(30)
                await event.delete()
...
async def approve_p_m(event):
    ...
    if Config.PM_LOGGR_BOT_API_ID is not None:
        if event.is_private:
            if pmpermit_sql.is_approved(chat.id):
                pmpermit_sql.disapprove(chat.id)
                await event.edit("███████▄▄███████████▄  \n▓▓▓▓▓▓█░░░░░░░░░░░░░░█\n▓▓▓▓▓▓█░░░░░░░░░░░░░░█\n▓▓▓▓▓▓█░░░░░░░░░░░░░░█\n▓▓▓▓▓▓█░░░░░░░░░░░░░░█\n▓▓▓▓▓▓█░░░░░░░░░░░░░░█\n▓▓▓▓▓▓███░░░░░░░░░░░░█\n██████▀▀▀█░░░░██████▀  \n░░░░░░░░░█░░░░█  \n░░░░░░░░░░█░░░█  \n░░░░░░░░░░░█░░█  \n░░░░░░░░░░░█░░█  \n░░░░░░░░░░░░▀▀ \n\n You Are Blocked, Now You Can't Send Message Me...")
                await asyncio.sleep(30)
