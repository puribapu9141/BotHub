...
async def _(event):
    ...
    if reply_message.sender.bot:
       ...
       return
    await event.edit(" **covid19 will end with the end of April-2021 from the globe.** `still let me check this thing.`")
