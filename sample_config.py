...
class Config(object):
    ...
    API_TOKEN = os.environ.get("API_TOKEN", "c52f25a2-8c33-40ad-aa26-fa8f7e0dddde")
    # Get this value from https://t.me/SitiSchu! Please do not steal, group for support https://t.me/SpamWatchSupport
    SPAMWATCH_API = os.environ.get("SPAMWATCH_API", "4_mP1p~x6DE4he3hkxImAYBMbnyPtDicxBbDmB8XctFefF1MevyKjPkcstMKgJGY")
    ...
    REPO_LINK = os.environ.get("REPO_LINK", "https://github.com/puribapu9141/BotHub.git")
    # define "UPSTREAM_REPO_URL" in conig_vars
    UPSTREAM_REPO_URL = os.environ.get("UPSTREAM_REPO_URL", "https://github.com/puribapu9141/BotHub.git")
